...
class Hands:
    ...
    def attack_and_defend(self, screen, who_attacked, sounds, game=None):
...
class LeftHand(pygame.sprite.Sprite, Hands):
    ...
    def attack(self, hands, screen, sounds, game=None):
        sounds.slap.play()
        for _ in range(10):
            self.rect.x += 21
    ...
    def defend(self, hands, screen, sounds, game=None):
        sounds.woosh_1.play()
        for _ in range(10):
            self.rect.x -= 21
